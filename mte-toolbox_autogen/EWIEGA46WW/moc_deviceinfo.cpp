...
static constexpr auto qt_meta_stringdata_ZN10deviceinfoE = QtMocHelpers::stringData(
    "deviceinfo"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10deviceinfoE[] = {
...
Q_CONSTINIT const QMetaObject deviceinfo::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10deviceinfoE.offsetsAndSizes,
    qt_meta_data_ZN10deviceinfoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10deviceinfoE_t,
        // Q_OBJECT / Q_GADGET
...
void *deviceinfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10deviceinfoE.stringdata0))
