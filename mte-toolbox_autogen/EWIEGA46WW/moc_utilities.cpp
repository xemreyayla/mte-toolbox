...
static constexpr auto qt_meta_stringdata_ZN9utilitiesE = QtMocHelpers::stringData(
    "utilities"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9utilitiesE[] = {
...
Q_CONSTINIT const QMetaObject utilities::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9utilitiesE.offsetsAndSizes,
    qt_meta_data_ZN9utilitiesE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9utilitiesE_t,
        // Q_OBJECT / Q_GADGET
...
void *utilities::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9utilitiesE.stringdata0))
